...
namespace prova.Model
{
    class DbClusterStore : IDbStore
    {
        ...
        public DbClusterStore(IConnectionPooling connectionFactory)  //IConnectionPooling connectionFactory  // ---> per connessione con un cluster + nodi
        {
